...
# Title: Top Block
# Generated: Thu Feb  7 12:57:21 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(5.8e9, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(5.8e9, 0)
        ...
        self.blocks_vector_source_x_1 = blocks.vector_source_c(numpy.concatenate((scipy.signal.hilbert(scipy.signal.chirp(numpy.linspace(0,1e-6,1e-6*samp_rate,endpoint=False), f0=0, f1=2.5e6, t1=1e-6, phi=90, method='linear')), [0j]*int(5e-6*samp_rate))), True, 1, [])

        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_vector_source_x_1, 0), (self.qtgui_waterfall_sink_x_2, 0))
        self.connect((self.blocks_vector_source_x_1, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(5.8e9, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.blocks_vector_source_x_1.set_data(numpy.concatenate((scipy.signal.hilbert(scipy.signal.chirp(numpy.linspace(0,1e-6,1e-6*self.samp_rate,endpoint=False), f0=0, f1=2.5e6, t1=1e-6, phi=90, method='linear')), [0j]*int(5e-6*self.samp_rate))), [])
