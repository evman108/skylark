...
if __name__ == '__main__':
	...
	parser.add_option("--freq", type="float", dest="freq", help="Optional Tx freq (Hz)", default=2575e6) #2484e6) #563e6
	...
	for line in sys.stdin:
		...
		input_buffer = realSamples + 1j * imagSamples

	num_samps = num_pulses*len(input_buffer)
	print(num_samps)
